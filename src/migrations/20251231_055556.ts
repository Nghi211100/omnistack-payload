...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_pages_blocks_archive_relation_to" AS ENUM('posts', 'services');
  CREATE TYPE "public"."enum_pages_blocks_media_content_block_alignment" AS ENUM('contentMedia', 'contentMedia');
  CREATE TYPE "public"."enum_pages_blocks_media_content_block_layout" AS ENUM('50/50', '40/60', '30/70', '60/40', '70/30');
  ...
  CREATE TYPE "public"."enum__pages_v_blocks_archive_relation_to" AS ENUM('posts', 'services');
  CREATE TYPE "public"."enum__pages_v_blocks_media_content_block_alignment" AS ENUM('contentMedia', 'contentMedia');
  CREATE TYPE "public"."enum__pages_v_blocks_media_content_block_layout" AS ENUM('50/50', '40/60', '30/70', '60/40', '70/30');
  ...
  CREATE TABLE "pages_blocks_media_content_block" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"alignment" "enum_pages_blocks_media_content_block_alignment",
  	"layout" "enum_pages_blocks_media_content_block_layout",
  	"media_id" integer,
  	"content" jsonb,
  	"block_name" varchar
  );
  ...
  CREATE TABLE "_pages_v_blocks_media_content_block" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"alignment" "enum__pages_v_blocks_media_content_block_alignment",
  	"layout" "enum__pages_v_blocks_media_content_block_layout",
  	"media_id" integer,
  	"content" jsonb,
  	"_uuid" varchar,
  	"block_name" varchar
  ...
  ALTER TABLE "pages_blocks_media_content_block" ADD CONSTRAINT "pages_blocks_media_content_block_media_id_media_id_fk" FOREIGN KEY ("media_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "pages_blocks_media_content_block" ADD CONSTRAINT "pages_blocks_media_content_block_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_pages_v_blocks_media_content_block" ADD CONSTRAINT "_pages_v_blocks_media_content_block_media_id_media_id_fk" FOREIGN KEY ("media_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_pages_v_blocks_media_content_block" ADD CONSTRAINT "_pages_v_blocks_media_content_block_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "pages_blocks_media_content_block_order_idx" ON "pages_blocks_media_content_block" USING btree ("_order");
  CREATE INDEX "pages_blocks_media_content_block_parent_id_idx" ON "pages_blocks_media_content_block" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_media_content_block_path_idx" ON "pages_blocks_media_content_block" USING btree ("_path");
  CREATE INDEX "pages_blocks_media_content_block_locale_idx" ON "pages_blocks_media_content_block" USING btree ("_locale");
  CREATE INDEX "pages_blocks_media_content_block_media_idx" ON "pages_blocks_media_content_block" USING btree ("media_id");
  ...
  CREATE INDEX "_pages_v_blocks_media_content_block_order_idx" ON "_pages_v_blocks_media_content_block" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_media_content_block_parent_id_idx" ON "_pages_v_blocks_media_content_block" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_media_content_block_path_idx" ON "_pages_v_blocks_media_content_block" USING btree ("_path");
  CREATE INDEX "_pages_v_blocks_media_content_block_locale_idx" ON "_pages_v_blocks_media_content_block" USING btree ("_locale");
  CREATE INDEX "_pages_v_blocks_media_content_block_media_idx" ON "_pages_v_blocks_media_content_block" USING btree ("media_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "pages_blocks_media_content_block" CASCADE;
  ...
  DROP TABLE "_pages_v_blocks_media_content_block" CASCADE;
  ...
  DROP TYPE "public"."enum_pages_blocks_media_content_block_alignment";
  DROP TYPE "public"."enum_pages_blocks_media_content_block_layout";
  ...
  DROP TYPE "public"."enum__pages_v_blocks_media_content_block_alignment";
  DROP TYPE "public"."enum__pages_v_blocks_media_content_block_layout";
